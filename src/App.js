...
import { Shield, MessageSquare, Book, Users, Lock, Cpu, Heart } from "lucide-react";
import heroImg from "./assets/hero.jpg"; // You'll add this image below
    ...
    <div className="min-h-screen flex flex-col bg-lightGray">
      ...
      <nav className="bg-primary text-white px-6 py-4 flex justify-between items-center shadow-md">
        <div className="flex items-center space-x-2">
          ...
          <span className="font-bold text-xl">SafeVoice</span>
        </div>

        <div className="hidden md:flex space-x-8 text-sm">
          <a href="#" className="hover:text-accent">Home</a>
          <a href="#" className="hover:text-accent">Support & Resources</a>
          <a href="#" className="hover:text-accent">Community & Awareness</a>
          <a href="#" className="hover:text-accent">AI Chatbot</a>
        </div>

        <button className="bg-accent text-white px-4 py-2 rounded-md font-medium hover:bg-sky-500 transition">
          Report Incident
        </button>
      </nav>
      ...
      <section className="py-16 px-6 grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="bg-white shadow-lg rounded-2xl p-6 text-center hover:shadow-2xl transition">
          ...
          <p className="text-gray-600">Step-by-step guidance for anonymous reporting</p>
        </div>

        <div className="bg-white shadow-lg rounded-2xl p-6 text-center hover:shadow-2xl transition">
          <Book className="w-10 h-10 text-blue-500 mx-auto mb-4" />
          <h3 className="text-lg font-semibold mb-2">Support & Resources</h3>
          <p className="text-gray-600">Access helplines, NGOs & safety resources</p>
        </div>

        <div className="bg-white shadow-lg rounded-2xl p-6 text-center hover:shadow-2xl transition">
          <Users className="w-10 h-10 text-blue-500 mx-auto mb-4" />
          <h3 className="text-lg font-semibold mb-2">Community Awareness</h3>
          <p className="text-gray-600">Read survivor stories & safety blogs</p>
        </div>
      </section>

      {/* Why Choose Section */}
      <section className="bg-white py-10 text-center">
        <h2 className="text-2xl font-semibold text-primary mb-8">Why Choose SafeVoice AI?</h2>
      ...
      <footer className="bg-primary text-white py-6 text-center">
        <p className="text-sm">&copy; 2025 SafeVoice</p>
        <div className="flex justify-center space-x-4 mt-2 text-gray-300">
